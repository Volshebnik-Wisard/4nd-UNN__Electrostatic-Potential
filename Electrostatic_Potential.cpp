...
// Electrostatic_Potential.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CElectrostatic_PotentialApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CElectrostatic_PotentialApp

CElectrostatic_PotentialApp::CElectrostatic_PotentialApp()
{
...
// Единственный объект CElectrostatic_PotentialApp

CElectrostatic_PotentialApp theApp;


// Инициализация CElectrostatic_PotentialApp

BOOL CElectrostatic_PotentialApp::InitInstance()
{
